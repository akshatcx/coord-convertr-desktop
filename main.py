import sys, os
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton,QErrorMessage, QWidget,QRadioButton, QLabel, QPlainTextEdit, QToolBar, QHBoxLayout, QVBoxLayout, QAction, QFileDialog, QMessageBox,QDialog
...
class AppDemo(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.utm2ll_rb = QRadioButton('UTM to LatLon [easting, northing, zone_number, zone_letter]')
